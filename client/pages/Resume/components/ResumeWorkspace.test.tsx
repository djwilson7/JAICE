...
describe('ResumeWorkspace', () => {
    ...
    const defaultProps: any = {
        ...
        hoveredEducationId: null, setHoveredEducationId: vi.fn(),
        hoveredSkillId: null, setHoveredSkillId: vi.fn(),
        ...
        hoveredEducationClearId: null, setHoveredEducationClearId: vi.fn(),
        ...
        hoveredSkillClearId: null, setHoveredSkillClearId: vi.fn(),
        ...
        updateEducationField: vi.fn(), addEducation: vi.fn(), removeEducation: vi.fn(), moveEducationUp: vi.fn(), moveEducationDown: vi.fn(), addEducationDetailWithText: vi.fn(), updateEducationDetailText: vi.fn(),
        addSkillCategory: vi.fn(), updateSkillCategoryName: vi.fn(), updateSkillCategoryItems: vi.fn(), removeSkillCategory: vi.fn(), moveSkillCategoryUp: vi.fn(), moveSkillCategoryDown: vi.fn(), clearSkillCategory: vi.fn(),
